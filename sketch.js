...
var engine, world, stand1, stand2, ball, ground, slingshot, polygon_img, backgroundImg, score = 0;
...
function draw() {
 if(backgroundImg) 
  ...
  stroke(15);
  fill("grey");
  text("Drag the Stone and Release it, to launch it towards the blocks", 50, 30);
